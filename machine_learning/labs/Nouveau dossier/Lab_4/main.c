...
void main(void) {
	...
	matrix_matrix_sub(1, NUM_OF_OUT_NODES, yhat, train_y, dZ2);
	printf("dZ2 \n");
	...
	matrix_matrix_multiplication(1, NUM_OF_OUT_NODES, NUM_OF_HID1_NODES, dZ2, w2, dA1);
	printf("dA1 \n");
	...
	relu_deriv(1, NUM_OF_HID1_NODES, z1, dZ1);
	relu_backward(1, NUM_OF_HID1_NODES, dA1, dZ1);
	printf("dZ1 \n");
	...
	bias_update(NUM_OF_HID1_NODES, learning_rate, db1, b1);
	printf("updated b1  \n");
	...
	bias_update(NUM_OF_OUT_NODES, learning_rate, db2, b2);
	printf("updated b2  \n");
